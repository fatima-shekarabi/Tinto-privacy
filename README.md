...
If you grant permission, the app uses the device camera to photograph museum artworks. Images are processed entirely on-device to extract dominant colors and detect the artwork's style, and are never uploaded to any server or third-party service.
